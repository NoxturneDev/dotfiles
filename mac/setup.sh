...
ln -sf "$DIR/.local/bin/agy-w" "$HOME/.local/bin/agy-w"
chmod +x "$DIR/setup.sh" "$HOME/.local/bin/switch-space" "$HOME/.local/bin/toggle-maximize" "$HOME/.local/bin/agy-w" "$HOME/.yabairc"
