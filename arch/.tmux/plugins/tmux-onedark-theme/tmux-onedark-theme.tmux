...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$onedark_blue,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_blue,bold] #h #[fg=$onedark_white, bg=$onedark_blue]#[fg=$onedark_white,bg=$onedark_white]"
set "status-left" "#[fg=$onedark_white,bg=$onedark_blue,bold] #S #{prefix_highlight}#[fg=$onedark_blue,bg=$onedark_white,nobold,nounderscore,noitalics]"
...
set "window-status-current-format" "#[fg=$onedark_white,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_visual_grey,nobold] #I  #W #[fg=$onedark_visual_grey,bg=$onedark_black,nobold,nounderscore,noitalics]"
